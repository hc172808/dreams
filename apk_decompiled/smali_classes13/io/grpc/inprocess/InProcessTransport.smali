...
.method public declared-synchronized newStream(Lio/grpc/MethodDescriptor;Lio/grpc/Metadata;Lio/grpc/CallOptions;)Lio/grpc/internal/ClientStream;
    ...
    iget v5, p0, Lio/grpc/inprocess/InProcessTransport;->serverMaxInboundMetadataSize:I
    ...
    iget-object v2, p0, Lio/grpc/inprocess/InProcessTransport;->attributes:Lio/grpc/Attributes;

    .line 197
    invoke-static {p3, v2, p2}, Lio/grpc/internal/StatsTraceContext;->newClientContext(Lio/grpc/CallOptions;Lio/grpc/Attributes;Lio/grpc/Metadata;)Lio/grpc/internal/StatsTraceContext;

    move-result-object v2

    .line 196
    invoke-direct {p0, v2, v1}, Lio/grpc/inprocess/InProcessTransport;->failedClientStream(Lio/grpc/internal/StatsTraceContext;Lio/grpc/Status;)Lio/grpc/internal/ClientStream;
...
.method public declared-synchronized start(Lio/grpc/internal/ManagedClientTransport$Listener;)Ljava/lang/Runnable;
    ...
    .end local p0    # "this":Lio/grpc/inprocess/InProcessTransport;
    :cond_0
    iget-object v1, p0, Lio/grpc/inprocess/InProcessTransport;->serverTransportListener:Lio/grpc/internal/ServerTransportListener;
    ...
    iget-object v3, p0, Lio/grpc/inprocess/InProcessTransport;->name:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/grpc/inprocess/InProcessTransport;->shutdownStatus:Lio/grpc/Status;

    .line 146
    nop

    .line 147
    .local v1, "localShutdownStatus":Lio/grpc/Status;
    new-instance v2, Lio/grpc/inprocess/InProcessTransport$2;

    invoke-direct {v2, p0, v1}, Lio/grpc/inprocess/InProcessTransport$2;-><init>(Lio/grpc/inprocess/InProcessTransport;Lio/grpc/Status;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 157
    .end local v1    # "localShutdownStatus":Lio/grpc/Status;
    :cond_1
    :try_start_1
    new-instance v1, Lio/grpc/inprocess/InProcessTransport$3;

    invoke-direct {v1, p0}, Lio/grpc/inprocess/InProcessTransport$3;-><init>(Lio/grpc/inprocess/InProcessTransport;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
