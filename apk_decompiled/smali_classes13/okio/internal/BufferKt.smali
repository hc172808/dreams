...
.method public static final commonEquals(Lokio/Buffer;Ljava/lang/Object;)Z
    ...
    .line 1395
    .end local v18    # "posA":I
    .end local v19    # "posB":I
...
.method public static final commonIndexOf(Lokio/Buffer;Lokio/ByteString;J)J
    ...
    .line 1267
    .local v13, "$i$a$-seek-BufferKt$commonIndexOf$5":I
    if-eqz v12, :cond_8
    ...
    .end local v13    # "$i$a$-seek-BufferKt$commonIndexOf$5":I
    .local v29, "s":Lokio/Segment;
    .local v30, "$i$a$-seek-BufferKt$commonIndexOf$5":I
    int-to-long v12, v3
    ...
    invoke-static {v1, v11, v7, v12, v0}, Lokio/internal/BufferKt;->rangeEquals(Lokio/Segment;I[BII)Z
    ...
    .end local v30    # "$i$a$-seek-BufferKt$commonIndexOf$5":I
    .local v10, "$i$f$seek":I
    .restart local v11    # "s$iv":Lokio/Segment;
    .restart local v12    # "s":Lokio/Segment;
    .restart local v13    # "$i$a$-seek-BufferKt$commonIndexOf$5":I
    :cond_7
    const-wide/16 v2, -0x1
    ...
    .local v2, "a$iv":I
    .local v26, "$i$a$-seek-BufferKt$commonIndexOf$5":I
    ...
    .line 1292
    .end local v26    # "$i$a$-seek-BufferKt$commonIndexOf$5":I
...
.method public static final commonIndexOfElement(Lokio/Buffer;Lokio/ByteString;J)J
    ...
    .local v21, "$i$f$commonIndexOfElement":I
    ...
    .local v22, "$i$a$-seek-BufferKt$commonIndexOfElement$2":I
    int-to-long v2, v2
    ...
    .end local v21    # "$i$f$commonIndexOfElement":I
    .end local v22    # "$i$a$-seek-BufferKt$commonIndexOfElement$2":I
    .local v1, "$i$f$commonIndexOfElement":I
    .local v2, "s":Lokio/Segment;
    .local v3, "$i$a$-seek-BufferKt$commonIndexOfElement$2":I
    :cond_7
    ...
    .restart local v21    # "$i$f$commonIndexOfElement":I
    .restart local v22    # "$i$a$-seek-BufferKt$commonIndexOfElement$2":I
    ...
    .restart local v3    # "$i$a$-seek-BufferKt$commonIndexOfElement$2":I
    :cond_8
    move/from16 v21, v1
    ...
    .local v2, "s":Lokio/Segment;
    .local v3, "$i$a$-seek-BufferKt$commonIndexOfElement$2":I
    .restart local v7    # "fromIndex$iv":J
    :cond_e
    move/from16 v21, v1
    ...
    .line 1301
    .local v8, "$i$a$-seek-BufferKt$commonIndexOfElement$2":I
    if-eqz v3, :cond_1b
    ...
    .line 1604
    .end local v3    # "s":Lokio/Segment;
    .end local v8    # "$i$a$-seek-BufferKt$commonIndexOfElement$2":I
    .local v6, "nextOffset$iv":J
    :cond_1c
    move-wide/from16 v17, v1
...
.method public static final commonRead(Lokio/Buffer;[BII)I
    ...
    invoke-virtual {v3, v1}, Lokio/SegmentPool;->recycle(Lokio/Segment;)V
...
.method public static final commonReadByte(Lokio/Buffer;)B
    ...
    invoke-virtual {v6, v1}, Lokio/SegmentPool;->recycle(Lokio/Segment;)V
...
.method public static final commonReadHexadecimalUnsignedLong(Lokio/Buffer;)J
    ...
    const-string v2, "$this$commonReadHexadecimalUnsignedLong"
...
.method public static final commonReadUtf8(Lokio/Buffer;J)Ljava/lang/String;
    ...
    invoke-static {v2, v3, v3, v4, v5}, Lokio/internal/_Utf8Kt;->commonToUtf8String$default([BIIILjava/lang/Object;)Ljava/lang/String;
...
.method public static final commonSkip(Lokio/Buffer;J)V
    ...
    invoke-virtual {v5, v3}, Lokio/SegmentPool;->recycle(Lokio/Segment;)V
