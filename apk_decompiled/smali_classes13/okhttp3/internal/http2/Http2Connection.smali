...
.method public final declared-synchronized awaitPong()V
    ...
    .restart local v0    # "$this$wait$iv":Ljava/lang/Object;
    .restart local v1    # "$i$f$wait":I
    :cond_0
...
.method public final writeData(IZLokio/Buffer;J)V
    ...
    .line 304
    iget-object v5, v1, Lokhttp3/internal/http2/Http2Connection;->writer:Lokhttp3/internal/http2/Http2Writer;

    invoke-virtual {v5, v3, v2, v4, v0}, Lokhttp3/internal/http2/Http2Writer;->data(ZILokio/Buffer;I)V
    ...
    .line 311
    .local v9, "toWrite":Lkotlin/jvm/internal/Ref$IntRef;
    monitor-enter p0

    const/4 v10, 0x0

    .line 312
    .local v10, "$i$a$-synchronized-Http2Connection$writeData$1":I
    nop

    .line 313
    :goto_1
    :try_start_0
    iget-wide v11, v1, Lokhttp3/internal/http2/Http2Connection;->writeBytesTotal:J

    iget-wide v13, v1, Lokhttp3/internal/http2/Http2Connection;->writeBytesMaximum:J
    ...
    .line 316
    iget-object v11, v1, Lokhttp3/internal/http2/Http2Connection;->streams:Ljava/util/Map;
    ...
    .local v11, "$this$wait$iv":Ljava/lang/Object;
    const/4 v12, 0x0
    ...
    .line 313
    .end local v11    # "$this$wait$iv":Ljava/lang/Object;
    .end local v12    # "$i$f$wait":I
    goto :goto_1

    .line 1005
    .restart local v11    # "$this$wait$iv":Ljava/lang/Object;
    .restart local v12    # "$i$f$wait":I
    :cond_1
    ...
    .end local v9    # "toWrite":Lkotlin/jvm/internal/Ref$IntRef;
    .end local v10    # "$i$a$-synchronized-Http2Connection$writeData$1":I
    .end local p1    # "streamId":I
    ...
    .restart local v9    # "toWrite":Lkotlin/jvm/internal/Ref$IntRef;
    .restart local v10    # "$i$a$-synchronized-Http2Connection$writeData$1":I
    ...
    iget-object v12, v1, Lokhttp3/internal/http2/Http2Connection;->writer:Lokhttp3/internal/http2/Http2Writer;

    invoke-virtual {v12}, Lokhttp3/internal/http2/Http2Writer;->maxDataLength()I
    ...
    iput-wide v11, v1, Lokhttp3/internal/http2/Http2Connection;->writeBytesTotal:J
    ...
    .line 332
    iget-object v10, v1, Lokhttp3/internal/http2/Http2Connection;->writer:Lokhttp3/internal/http2/Http2Writer;
    ...
    invoke-virtual {v10, v11, v2, v4, v12}, Lokhttp3/internal/http2/Http2Writer;->data(ZILokio/Buffer;I)V
