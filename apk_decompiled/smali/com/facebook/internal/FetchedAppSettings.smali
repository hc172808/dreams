...
.method public constructor <init>(ZLjava/lang/String;ZILjava/util/EnumSet;Ljava/util/Map;ZLcom/facebook/internal/FacebookRequestErrorClassification;Ljava/lang/String;Ljava/lang/String;ZZLorg/json/JSONArray;Ljava/lang/String;ZZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .param p4, "sessionTimeoutInSeconds"    # I
    .param p5, "smartLoginOptions"    # Ljava/util/EnumSet;
    .param p6, "dialogConfigurations"    # Ljava/util/Map;
    .param p7, "automaticLoggingEnabled"    # Z
    .param p8, "errorClassification"    # Lcom/facebook/internal/FacebookRequestErrorClassification;
    .param p9, "smartLoginBookmarkIconURL"    # Ljava/lang/String;
    .param p10, "smartLoginMenuIconURL"    # Ljava/lang/String;
    .param p11, "iAPAutomaticLoggingEnabled"    # Z
    .param p12, "codelessEventsEnabled"    # Z
    .param p13, "eventBindings"    # Lorg/json/JSONArray;
    .param p14, "sdkUpdateMessage"    # Ljava/lang/String;
    .param p15, "trackUninstallEnabled"    # Z
    .param p16, "monitorViaDialogEnabled"    # Z
    .param p17, "rawAamRules"    # Ljava/lang/String;
    .param p18, "suggestedEventsSetting"    # Ljava/lang/String;
    .param p19, "restrictiveDataSetting"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
            "Ljava/lang/String;",
    ...
    iput-boolean v9, v0, Lcom/facebook/internal/FetchedAppSettings;->nuxEnabled:Z

    move/from16 v10, p4

    iput v10, v0, Lcom/facebook/internal/FetchedAppSettings;->sessionTimeoutInSeconds:I
    ...
    iput-boolean v11, v0, Lcom/facebook/internal/FetchedAppSettings;->automaticLoggingEnabled:Z
    ...
    iput-boolean v15, v0, Lcom/facebook/internal/FetchedAppSettings;->trackUninstallEnabled:Z
