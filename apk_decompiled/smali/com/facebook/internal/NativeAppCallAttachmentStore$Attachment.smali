...
.method public constructor <init>(Ljava/util/UUID;Landroid/graphics/Bitmap;Landroid/net/Uri;)V
    ...
    .local v3, "$this$with":Ljava/lang/String;
    const/4 v4, 0x0

    .line 216
    .local v4, "$i$a$-with-NativeAppCallAttachmentStore$Attachment$1":I
    const/4 v5, 0x0
    ...
    invoke-static {v3, v7, v5, v6, v0}, Lkotlin/text/StringsKt;->startsWith$default(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
    ...
    .end local v3    # "$this$with":Ljava/lang/String;
    .end local v4    # "$i$a$-with-NativeAppCallAttachmentStore$Attachment$1":I
    :goto_0
    ...
    .line 232
    :cond_6
    sget-object v1, Lcom/facebook/FacebookContentProvider;->Companion:Lcom/facebook/FacebookContentProvider$Companion;
    ...
    .line 232
    invoke-virtual {v1, v2, p1, v0}, Lcom/facebook/FacebookContentProvider$Companion;->getAttachmentUrl(Ljava/lang/String;Ljava/util/UUID;Ljava/lang/String;)Ljava/lang/String;
