...
.method private static declared-synchronized setCurrentPendingCall(Lcom/facebook/internal/AppCall;)Z
    ...
    .line 54
    .local p0, "appCall":Lcom/facebook/internal/AppCall;
    :cond_0
    :try_start_1
    invoke-static {}, Lcom/facebook/internal/AppCall;->getCurrentPendingCall()Lcom/facebook/internal/AppCall;
...
.method public getCallId()Ljava/util/UUID;
    ...
    .line 99
    .local v0, "this":Lcom/facebook/internal/AppCall;
    :try_start_0
    iget-object v1, v0, Lcom/facebook/internal/AppCall;->callId:Ljava/util/UUID;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    return-object v1

    .end local v0    # "this":Lcom/facebook/internal/AppCall;
    :catchall_0
    move-exception v2
...
.method public getRequestCode()I
    ...
    .local v0, "this":Lcom/facebook/internal/AppCall;
    :try_start_0
    iget v1, v0, Lcom/facebook/internal/AppCall;->requestCode:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getRequestIntent()Landroid/content/Intent;
    ...
    .local v0, "this":Lcom/facebook/internal/AppCall;
    :try_start_0
    iget-object v1, v0, Lcom/facebook/internal/AppCall;->requestIntent:Landroid/content/Intent;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setPending()Z
    ...
    .local v0, "this":Lcom/facebook/internal/AppCall;
    :try_start_0
    invoke-static {v0}, Lcom/facebook/internal/AppCall;->setCurrentPendingCall(Lcom/facebook/internal/AppCall;)Z
...
.method public setRequestCode(I)V
    ...
    .local p1, "requestCode":I
    :try_start_0
    iput p1, v0, Lcom/facebook/internal/AppCall;->requestCode:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setRequestIntent(Landroid/content/Intent;)V
    ...
    .line 116
    .local v0, "this":Lcom/facebook/internal/AppCall;
    .local p1, "requestIntent":Landroid/content/Intent;
    :try_start_0
    iput-object p1, v0, Lcom/facebook/internal/AppCall;->requestIntent:Landroid/content/Intent;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .end local v0    # "this":Lcom/facebook/internal/AppCall;
    .end local p1    # "requestIntent":Landroid/content/Intent;
    :catchall_0
    move-exception p1
