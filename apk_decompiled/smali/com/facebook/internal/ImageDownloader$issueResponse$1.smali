...
.method public final run()V
    ...
    .line 187
    .local v0, "this":Lcom/facebook/internal/ImageDownloader$issueResponse$1;
    :try_start_1
    new-instance v1, Lcom/facebook/internal/ImageResponse;

    iget-object v2, v0, Lcom/facebook/internal/ImageDownloader$issueResponse$1;->$request:Lcom/facebook/internal/ImageRequest;

    iget-object v3, v0, Lcom/facebook/internal/ImageDownloader$issueResponse$1;->$error:Ljava/lang/Exception;

    iget-boolean v4, v0, Lcom/facebook/internal/ImageDownloader$issueResponse$1;->$isCachedRedirect:Z

    iget-object v5, v0, Lcom/facebook/internal/ImageDownloader$issueResponse$1;->$bitmap:Landroid/graphics/Bitmap;

    invoke-direct {v1, v2, v3, v4, v5}, Lcom/facebook/internal/ImageResponse;-><init>(Lcom/facebook/internal/ImageRequest;Ljava/lang/Exception;ZLandroid/graphics/Bitmap;)V

    .line 188
    .local v1, "response":Lcom/facebook/internal/ImageResponse;
    iget-object v2, v0, Lcom/facebook/internal/ImageDownloader$issueResponse$1;->$callback:Lcom/facebook/internal/ImageRequest$Callback;

    invoke-interface {v2, v1}, Lcom/facebook/internal/ImageRequest$Callback;->onCompleted(Lcom/facebook/internal/ImageResponse;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 189
    .end local v1    # "response":Lcom/facebook/internal/ImageResponse;
    return-void

    .end local v0    # "this":Lcom/facebook/internal/ImageDownloader$issueResponse$1;
    :catchall_0
    move-exception v1
