...
.method public static final addAttachments(Ljava/util/Collection;)V
    .locals 7
    .param p0, "attachments"    # Ljava/util/Collection;
    ...
    .line 101
    .local v0, "filesToCleanup":Ljava/util/List;
    nop
    ...
    invoke-virtual {v2}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->getShouldCreateFile()Z
    ...
    .line 106
    :cond_2
    invoke-virtual {v2}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->getCallId()Ljava/util/UUID;

    move-result-object v3

    invoke-virtual {v2}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->getAttachmentName()Ljava/lang/String;
    ...
    .line 109
    invoke-virtual {v2}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->getBitmap()Landroid/graphics/Bitmap;
    ...
    .line 110
    sget-object v4, Lcom/facebook/internal/NativeAppCallAttachmentStore;->INSTANCE:Lcom/facebook/internal/NativeAppCallAttachmentStore;

    invoke-virtual {v2}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->getBitmap()Landroid/graphics/Bitmap;

    move-result-object v5

    invoke-direct {v4, v5, v3}, Lcom/facebook/internal/NativeAppCallAttachmentStore;->processAttachmentBitmap(Landroid/graphics/Bitmap;Ljava/io/File;)V

    goto :goto_1

    .line 111
    :cond_3
    invoke-virtual {v2}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->getOriginalUri()Landroid/net/Uri;
    ...
    invoke-virtual {v2}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->isContentUri()Z

    move-result v6

    invoke-direct {v4, v5, v6, v3}, Lcom/facebook/internal/NativeAppCallAttachmentStore;->processAttachmentFile(Landroid/net/Uri;ZLjava/io/File;)V
    :try_end_0
    ...
    .line 92
    .end local v0    # "filesToCleanup":Ljava/util/List;
