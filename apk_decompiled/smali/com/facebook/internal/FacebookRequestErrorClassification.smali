...
.method public constructor <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    .param p1, "otherErrors"    # Ljava/util/Map;
    .param p2, "transientErrors"    # Ljava/util/Map;
    .param p3, "loginRecoverableErrors"    # Ljava/util/Map;
...
.method public static final synthetic access$setDefaultInstance$cp(Lcom/facebook/internal/FacebookRequestErrorClassification;)V
    .locals 0
    .param p0, "<set-?>"    # Lcom/facebook/internal/FacebookRequestErrorClassification;
...
.method public final classify(IIZ)Lcom/facebook/FacebookRequestError$Category;
    ...
    .line 60
    .local v0, "subCodes":Ljava/util/Set;
    if-eqz v0, :cond_1
    ...
    .line 64
    .end local v0    # "subCodes":Ljava/util/Set;
    :cond_2
    ...
    .line 66
    .restart local v0    # "subCodes":Ljava/util/Set;
    if-eqz v0, :cond_3
