...
.method private sendResult(ILandroid/content/Intent;)V
    ...
    .line 125
    .local v1, "responseURL":Ljava/lang/String;
    if-eqz v1, :cond_0
    ...
    invoke-static {v3, v2, v0}, Lcom/facebook/internal/NativeProtocol;->createProtocolResultIntent(Landroid/content/Intent;Landroid/os/Bundle;Lcom/facebook/FacebookException;)Landroid/content/Intent;

    move-result-object v0

    .line 129
    .local v0, "nativeProtocolResultIntent":Landroid/content/Intent;
    if-eqz v0, :cond_1
    ...
    :goto_1
    invoke-virtual {p0, p1, v3}, Lcom/facebook/CustomTabMainActivity;->setResult(ILandroid/content/Intent;)V

    .line 132
    .end local v0    # "nativeProtocolResultIntent":Landroid/content/Intent;
    .end local v1    # "responseURL":Ljava/lang/String;
    ...
    invoke-static {v1, v0, v0}, Lcom/facebook/internal/NativeProtocol;->createProtocolResultIntent(Landroid/content/Intent;Landroid/os/Bundle;Lcom/facebook/FacebookException;)Landroid/content/Intent;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lcom/facebook/CustomTabMainActivity;->setResult(ILandroid/content/Intent;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 67
    .local v3, "chromePackage":Ljava/lang/String;
    new-instance v4, Lcom/facebook/internal/CustomTab;

    invoke-direct {v4, v0, v2}, Lcom/facebook/internal/CustomTab;-><init>(Ljava/lang/String;Landroid/os/Bundle;)V

    .line 68
    .local v4, "customTab":Lcom/facebook/internal/CustomTab;
    invoke-virtual {v4, p0, v3}, Lcom/facebook/internal/CustomTab;->openCustomTab(Landroid/app/Activity;Ljava/lang/String;)Z

    move-result v5

    .line 69
    .local v5, "couldOpenCustomTab":Z
    ...
    sget-object v7, Lcom/facebook/CustomTabMainActivity;->NO_ACTIVITY_EXCEPTION:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v6}, Lcom/facebook/CustomTabMainActivity;->setResult(ILandroid/content/Intent;)V
    ...
    .line 78
    :cond_1
    new-instance v1, Lcom/facebook/CustomTabMainActivity$1;

    invoke-direct {v1, p0}, Lcom/facebook/CustomTabMainActivity$1;-><init>(Lcom/facebook/CustomTabMainActivity;)V

    iput-object v1, p0, Lcom/facebook/CustomTabMainActivity;->redirectReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v6, p0, Lcom/facebook/CustomTabMainActivity;->redirectReceiver:Landroid/content/BroadcastReceiver;

    new-instance v7, Landroid/content/IntentFilter;

    sget-object v8, Lcom/facebook/CustomTabActivity;->CUSTOM_TAB_REDIRECT_ACTION:Ljava/lang/String;

    invoke-direct {v7, v8}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    .line 92
    invoke-virtual {v1, v6, v7}, Landroidx/localbroadcastmanager/content/LocalBroadcastManager;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V

    .line 95
    .end local v0    # "action":Ljava/lang/String;
    .end local v2    # "parameters":Landroid/os/Bundle;
    .end local v3    # "chromePackage":Ljava/lang/String;
    .end local v4    # "customTab":Lcom/facebook/internal/CustomTab;
    .end local v5    # "couldOpenCustomTab":Z
    :cond_2
    return-void
.end method
