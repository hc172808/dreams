...
.method public onCompleted(Lcom/facebook/GraphResponse;)V
    ...
    iget-object v0, v1, Lcom/facebook/login/DeviceAuthDialog$8;->this$0:Lcom/facebook/login/DeviceAuthDialog;
    ...
    invoke-static {v0}, Lcom/facebook/internal/Utility;->handlePermissionResponse(Lorg/json/JSONObject;)Lcom/facebook/internal/Utility$PermissionsLists;

    move-result-object v5

    .line 448
    .local v5, "permissions":Lcom/facebook/internal/Utility$PermissionsLists;
    ...
    iget-object v2, v1, Lcom/facebook/login/DeviceAuthDialog$8;->this$0:Lcom/facebook/login/DeviceAuthDialog;

    invoke-static {v2}, Lcom/facebook/login/DeviceAuthDialog;->access$900(Lcom/facebook/login/DeviceAuthDialog;)Z
    ...
    invoke-static {v2, v3}, Lcom/facebook/login/DeviceAuthDialog;->access$902(Lcom/facebook/login/DeviceAuthDialog;Z)Z

    .line 462
    iget-object v3, v1, Lcom/facebook/login/DeviceAuthDialog$8;->this$0:Lcom/facebook/login/DeviceAuthDialog;

    iget-object v6, v1, Lcom/facebook/login/DeviceAuthDialog$8;->val$accessToken:Ljava/lang/String;

    iget-object v8, v1, Lcom/facebook/login/DeviceAuthDialog$8;->val$expirationTime:Ljava/util/Date;

    iget-object v9, v1, Lcom/facebook/login/DeviceAuthDialog$8;->val$dataAccessExpirationTimeDate:Ljava/util/Date;

    invoke-static/range {v3 .. v9}, Lcom/facebook/login/DeviceAuthDialog;->access$1000(Lcom/facebook/login/DeviceAuthDialog;Ljava/lang/String;Lcom/facebook/internal/Utility$PermissionsLists;Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
    ...
    .line 472
    :cond_2
    iget-object v10, v1, Lcom/facebook/login/DeviceAuthDialog$8;->this$0:Lcom/facebook/login/DeviceAuthDialog;

    iget-object v13, v1, Lcom/facebook/login/DeviceAuthDialog$8;->val$accessToken:Ljava/lang/String;

    iget-object v14, v1, Lcom/facebook/login/DeviceAuthDialog$8;->val$expirationTime:Ljava/util/Date;

    iget-object v15, v1, Lcom/facebook/login/DeviceAuthDialog$8;->val$dataAccessExpirationTimeDate:Ljava/util/Date;

    move-object v11, v4

    move-object v12, v5

    invoke-static/range {v10 .. v15}, Lcom/facebook/login/DeviceAuthDialog;->access$800(Lcom/facebook/login/DeviceAuthDialog;Ljava/lang/String;Lcom/facebook/internal/Utility$PermissionsLists;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
    ...
    .end local v5    # "permissions":Lcom/facebook/internal/Utility$PermissionsLists;
