...
.method public completed(Landroid/os/Bundle;)V
    ...
    .line 800
    .local v17, "expires":Ljava/util/Date;
    nop
    ...
    .line 802
    .local v18, "permissions":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    nop

    .line 803
    const-string/jumbo v5, "signed request"
    ...
    .line 804
    .local v19, "signedRequest":Ljava/lang/String;
    nop
    ...
    .line 806
    .local v20, "graphDomain":Ljava/lang/String;
    new-instance v5, Ljava/util/Date;
    ...
    .line 809
    .local v21, "dataAccessExpirationTime":Ljava/util/Date;
    const/4 v5, 0x0
    ...
    .line 811
    invoke-static/range {v19 .. v19}, Lcom/facebook/login/LoginMethodHandler;->getUserIDFromSignedRequest(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 817
    invoke-static/range {v22 .. v22}, Lcom/facebook/internal/Utility;->isNullOrEmpty(Ljava/lang/String;)Z
    ...
    .line 818
    new-instance v23, Lcom/facebook/AccessToken;
    ...
    .line 834
    iget-object v6, v0, Lcom/facebook/login/LoginManager$4;->val$logger:Lcom/facebook/login/LoginLogger;

    iget-object v7, v0, Lcom/facebook/login/LoginManager$4;->val$loggerRef:Ljava/lang/String;

    invoke-virtual {v6, v7}, Lcom/facebook/login/LoginLogger;->logLoginStatusSuccess(Ljava/lang/String;)V

    .line 835
    iget-object v6, v0, Lcom/facebook/login/LoginManager$4;->val$responseCallback:Lcom/facebook/LoginStatusCallback;

    invoke-interface {v6, v5}, Lcom/facebook/LoginStatusCallback;->onCompleted(Lcom/facebook/AccessToken;)V
    ...
    .end local v17    # "expires":Ljava/util/Date;
    .end local v18    # "permissions":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .end local v19    # "signedRequest":Ljava/lang/String;
    .end local v20    # "graphDomain":Ljava/lang/String;
    .end local v21    # "dataAccessExpirationTime":Ljava/util/Date;
