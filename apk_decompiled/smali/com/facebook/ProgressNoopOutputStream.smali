...
.method public final addProgress(J)V
    ...
    .line 44
    .local v0, "currentRequest":Lcom/facebook/GraphRequest;
    ...
    .line 46
    .local v1, "requestProgress":Lcom/facebook/RequestProgress;
    ...
    .line 49
    .end local v1    # "requestProgress":Lcom/facebook/RequestProgress;
    :cond_0
    iget-object v1, p0, Lcom/facebook/ProgressNoopOutputStream;->currentRequestProgress:Lcom/facebook/RequestProgress;

    if-eqz v1, :cond_1

    invoke-virtual {v1, p1, p2}, Lcom/facebook/RequestProgress;->addToMax(J)V

    .line 50
    :cond_1
    iget v1, p0, Lcom/facebook/ProgressNoopOutputStream;->maxProgress:I

    long-to-int v2, p1

    add-int/2addr v1, v2

    iput v1, p0, Lcom/facebook/ProgressNoopOutputStream;->maxProgress:I

    .line 51
    return-void

    .line 43
    .end local v0    # "currentRequest":Lcom/facebook/GraphRequest;
    :cond_2
    return-void
.end method
