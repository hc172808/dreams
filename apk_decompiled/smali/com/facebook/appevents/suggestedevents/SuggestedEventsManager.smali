...
.method private static initialize()V
    ...
    .line 70
    .local v2, "rawSuggestedEventSetting":Ljava/lang/String;
    if-nez v2, :cond_2
    ...
    .line 73
    :cond_2
    invoke-static {v2}, Lcom/facebook/appevents/suggestedevents/SuggestedEventsManager;->populateEventsFromRawJsonString(Ljava/lang/String;)V

    .line 75
    sget-object v3, Lcom/facebook/appevents/suggestedevents/SuggestedEventsManager;->productionEvents:Ljava/util/Set;
    ...
    sget-object v3, Lcom/facebook/appevents/suggestedevents/SuggestedEventsManager;->eligibleEvents:Ljava/util/Set;
    ...
    invoke-static {v3}, Lcom/facebook/appevents/ml/ModelManager;->getRuleFile(Lcom/facebook/appevents/ml/ModelManager$Task;)Ljava/io/File;

    move-result-object v3

    .line 77
    .local v3, "ruleFile":Ljava/io/File;
    if-nez v3, :cond_4
    ...
    .line 80
    :cond_4
    invoke-static {v3}, Lcom/facebook/appevents/suggestedevents/FeatureExtractor;->initialize(Ljava/io/File;)V
    ...
    .line 82
    .local v4, "currActivity":Landroid/app/Activity;
    if-eqz v4, :cond_5

    .line 83
    invoke-static {v4}, Lcom/facebook/appevents/suggestedevents/SuggestedEventsManager;->trackActivity(Landroid/app/Activity;)V
    :try_end_0
    ...
    .end local v2    # "rawSuggestedEventSetting":Ljava/lang/String;
    .end local v3    # "ruleFile":Ljava/io/File;
    .end local v4    # "currActivity":Landroid/app/Activity;
    :cond_5
    goto :goto_0
...
.method static isEligibleEvents(Ljava/lang/String;)Z
    ...
    .line 135
    .local p0, "event":Ljava/lang/String;
    :cond_0
    :try_start_0
...
.method protected static populateEventsFromRawJsonString(Ljava/lang/String;)V
    ...
    .line 93
    .local p0, "rawSuggestedEventSetting":Ljava/lang/String;
    :cond_0
    :try_start_0
    ...
    .line 104
    sget-object v4, Lcom/facebook/appevents/suggestedevents/SuggestedEventsManager;->eligibleEvents:Ljava/util/Set;
    ...
    .line 110
    .end local p0    # "rawSuggestedEventSetting":Ljava/lang/String;
    :catchall_0
    move-exception p0
    ...
    .line 107
    .restart local p0    # "rawSuggestedEventSetting":Ljava/lang/String;
    :catch_0
    move-exception v0
