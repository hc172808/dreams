...
.method private constructor <init>(Landroid/view/View;Landroid/view/View;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;->activityName:Ljava/lang/String;
...
.method static synthetic access$100(Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;)Ljava/lang/String;
    ...
    .line 48
    .local p0, "x0":Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;
    :cond_0
    :try_start_0
    iget-object v0, p0, Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;->activityName:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    return-object v0

    .end local p0    # "x0":Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;
    :catchall_0
    move-exception p0
...
.method private predictAndProcess(Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;)V
    ...
    .line 136
    .local v0, "this":Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;
    .local p1, "pathID":Ljava/lang/String;
    .local p2, "buttonText":Ljava/lang/String;
    .local p3, "viewData":Lorg/json/JSONObject;
    :try_start_0
    new-instance v1, Lcom/facebook/appevents/suggestedevents/ViewOnClickListener$2;

    invoke-direct {v1, v0, p3, p2, p1}, Lcom/facebook/appevents/suggestedevents/ViewOnClickListener$2;-><init>(Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .end local v0    # "this":Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;
    .end local p1    # "pathID":Ljava/lang/String;
    .end local p2    # "buttonText":Ljava/lang/String;
    .end local p3    # "viewData":Lorg/json/JSONObject;
    :catchall_0
    move-exception p1
...
.method private process()V
    ...
    .local v0, "this":Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;
    :try_start_0
    iget-object v1, v0, Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;->rootViewWeakReference:Ljava/lang/ref/WeakReference;
    ...
    iget-object v2, v0, Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;->hostViewWeakReference:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v2, v3}, Lcom/facebook/appevents/suggestedevents/PredictionHistoryManager;->getPathID(Landroid/view/View;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 99
    :cond_2
    invoke-static {v4, v3}, Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;->queryHistoryAndProcess(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v1, v2}, Lcom/facebook/appevents/suggestedevents/SuggestedEventViewHierarchy;->getDictionaryOfView(Landroid/view/View;Landroid/view/View;)Lorg/json/JSONObject;
    ...
    iget-object v7, v0, Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;->activityName:Ljava/lang/String;

    invoke-virtual {v5, v6, v7}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    .line 107
    invoke-direct {v0, v4, v3, v5}, Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;->predictAndProcess(Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;)V
    :try_end_1
    ...
    .line 89
    .restart local v0    # "this":Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;
    :cond_4
    :goto_1
    return-void
...
.method private static processPredictedResult(Ljava/lang/String;Ljava/lang/String;[F)V
    ...
    .line 173
    .local p0, "predictedEvent":Ljava/lang/String;
    .local p1, "buttonText":Ljava/lang/String;
    .local p2, "dense":[F
    :cond_0
    :try_start_0
    ...
    invoke-virtual {v1, p0, p1}, Lcom/facebook/appevents/InternalAppEventsLogger;->logEventFromSE(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .end local p0    # "predictedEvent":Ljava/lang/String;
    .end local p1    # "buttonText":Ljava/lang/String;
    .end local p2    # "dense":[F
    :catchall_0
    move-exception p0
...
.method private static queryHistoryAndProcess(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 116
    .local p0, "pathID":Ljava/lang/String;
    .local p1, "buttonText":Ljava/lang/String;
    :cond_0
    :try_start_0
    ...
    .line 117
    .local v1, "queriedEvent":Ljava/lang/String;
    if-nez v1, :cond_1
    ...
    .line 122
    new-instance v3, Lcom/facebook/appevents/suggestedevents/ViewOnClickListener$1;

    invoke-direct {v3, v1, p1}, Lcom/facebook/appevents/suggestedevents/ViewOnClickListener$1;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {v3}, Lcom/facebook/internal/Utility;->runOnNonUiThread(Ljava/lang/Runnable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .end local v1    # "queriedEvent":Ljava/lang/String;
    .end local p0    # "pathID":Ljava/lang/String;
    .end local p1    # "buttonText":Ljava/lang/String;
    :catchall_0
    move-exception p0
...
.method private static sendPredictedResult(Ljava/lang/String;Ljava/lang/String;[F)V
    ...
    .line 184
    .local p0, "eventToPost":Ljava/lang/String;
    .local p1, "buttonText":Ljava/lang/String;
    .local p2, "dense":[F
    :cond_0
    :try_start_0
    ...
    .line 186
    .local v1, "publishParams":Landroid/os/Bundle;
    :try_start_1
    ...
    .line 190
    .local v3, "denseSB":Ljava/lang/StringBuilder;
    array-length v4, p2
    ...
    const-string v6, "%s/suggested_events"
    ...
    invoke-static {v5, v4, v5, v5}, Lcom/facebook/GraphRequest;->newPostRequest(Lcom/facebook/AccessToken;Ljava/lang/String;Lorg/json/JSONObject;Lcom/facebook/GraphRequest$Callback;)Lcom/facebook/GraphRequest;

    move-result-object v4

    .line 202
    .local v4, "postRequest":Lcom/facebook/GraphRequest;
    ...
    .end local v3    # "denseSB":Ljava/lang/StringBuilder;
    .end local v4    # "postRequest":Lcom/facebook/GraphRequest;
    goto :goto_1
    ...
    .end local v1    # "publishParams":Landroid/os/Bundle;
    .end local p0    # "eventToPost":Ljava/lang/String;
    .end local p1    # "buttonText":Ljava/lang/String;
    .end local p2    # "dense":[F
    :catchall_0
    move-exception p0
...
.method public onClick(Landroid/view/View;)V
    ...
    :try_start_0
    iget-object v1, v0, Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;->baseListener:Landroid/view/View$OnClickListener;
    ...
    .end local v0    # "this":Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;
    :cond_1
    invoke-direct {v0}, Lcom/facebook/appevents/suggestedevents/ViewOnClickListener;->process()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
