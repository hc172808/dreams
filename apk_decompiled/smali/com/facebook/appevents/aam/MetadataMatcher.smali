...
.method static getAroundViewIndicators(Landroid/view/View;)Ljava/util/List;
    ...
    .line 76
    .local v1, "aroundTextIndicators":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 80
    invoke-static {v5}, Lcom/facebook/appevents/aam/MetadataMatcher;->getTextIndicators(Landroid/view/View;)Ljava/util/List;
    ...
    .end local v1    # "aroundTextIndicators":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
...
.method static getCurrentViewIndicators(Landroid/view/View;)Ljava/util/List;
    ...
    .line 40
    .local v1, "indicators":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 66
    .local v5, "validIndicators":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 67
    .local v7, "indicator":Ljava/lang/String;
    ...
    .line 70
    .end local v7    # "indicator":Ljava/lang/String;
    :cond_4
    goto :goto_1
    ...
    .end local v1    # "indicators":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v3    # "tag":Ljava/lang/Object;
    .end local v4    # "description":Ljava/lang/CharSequence;
    .end local v5    # "validIndicators":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local p0    # "view":Landroid/view/View;
    :catchall_0
    move-exception p0
...
.method static matchIndicator(Ljava/lang/String;Ljava/util/List;)Z
    ...
    .line 97
    .local p0, "indicator":Ljava/lang/String;
    ...
    .end local p0    # "indicator":Ljava/lang/String;
...
.method static matchIndicator(Ljava/util/List;Ljava/util/List;)Z
    ...
    .line 88
    .local p0, "indicators":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .local p1, "keys":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_0
    :try_start_0
    ...
    invoke-static {v3, p1}, Lcom/facebook/appevents/aam/MetadataMatcher;->matchIndicator(Ljava/lang/String;Ljava/util/List;)Z
    ...
    .end local p0    # "indicators":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local p1    # "keys":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :catchall_0
    move-exception p0
...
.method static matchValue(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .local p1, "rule":Ljava/lang/String;
    :cond_0
    :try_start_0
    ...
    .end local p1    # "rule":Ljava/lang/String;
    :catchall_0
    move-exception p0
