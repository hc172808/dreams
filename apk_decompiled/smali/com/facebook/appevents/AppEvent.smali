...
.method private constructor <init>(Ljava/lang/String;ZZLjava/lang/String;)V
    ...
    const-string v1, "jsonObject.optString(Con\u2026nts.EVENT_NAME_EVENT_KEY)"
...
.method private final calculateChecksum()Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Lcom/facebook/appevents/AppEvent$Companion;->access$md5Checksum(Lcom/facebook/appevents/AppEvent$Companion;Ljava/lang/String;)Ljava/lang/String;
...
.method private final getJSONObjectForAppEvent(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Double;Landroid/os/Bundle;Ljava/util/UUID;)Lorg/json/JSONObject;
    ...
    .line 110
    .local v2, "eventObject":Lorg/json/JSONObject;
    invoke-static {v0}, Lcom/facebook/appevents/restrictivedatafilter/RestrictiveDataManager;->processEvent(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 112
    invoke-static {v1, v0}, Lcom/facebook/appevents/AppEvent$Companion;->access$md5Checksum(Lcom/facebook/appevents/AppEvent$Companion;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 120
    .local v1, "processedParam":Ljava/util/Map;
    ...
    .line 124
    .end local v1    # "processedParam":Ljava/util/Map;
    :cond_1
    if-eqz p3, :cond_2
    ...
    .line 127
    :cond_2
    iget-boolean v1, p0, Lcom/facebook/appevents/AppEvent;->inBackground:Z
    ...
    const-string v7, "eventObject.toString()"
    ...
    invoke-virtual {v1, v3, v5, v6, v4}, Lcom/facebook/internal/Logger$Companion;->log(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private final validateParameters(Landroid/os/Bundle;)Ljava/util/Map;
    ...
    .line 140
    .local v0, "paramMap":Ljava/util/Map;
    ...
    invoke-static {v0, v1}, Lcom/facebook/appevents/restrictivedatafilter/RestrictiveDataManager;->processParameters(Ljava/util/Map;Ljava/lang/String;)V

    .line 154
    iget-object v1, p0, Lcom/facebook/appevents/AppEvent;->name:Ljava/lang/String;

    invoke-static {v0, v1}, Lcom/facebook/appevents/eventdeactivation/EventDeactivationManager;->processDeprecatedParameters(Ljava/util/Map;Ljava/lang/String;)V
