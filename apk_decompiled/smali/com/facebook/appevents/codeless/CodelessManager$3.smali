...
.method public run()V
    ...
    .line 160
    .local v1, "this":Lcom/facebook/appevents/codeless/CodelessManager$3;
    :try_start_0
    ...
    iget-object v6, v1, Lcom/facebook/appevents/codeless/CodelessManager$3;->val$applicationId:Ljava/lang/String;
    ...
    .line 172
    .end local v1    # "this":Lcom/facebook/appevents/codeless/CodelessManager$3;
    :cond_1
    ...
    .line 174
    invoke-static {v6}, Lcom/facebook/internal/AttributionIdentifiers;->getAttributionIdentifiers(Landroid/content/Context;)Lcom/facebook/internal/AttributionIdentifiers;
    ...
    .line 177
    .local v9, "extInfoArray":Lorg/json/JSONArray;
    ...
    .line 197
    .local v11, "res":Lcom/facebook/GraphResponse;
    invoke-virtual {v11}, Lcom/facebook/GraphResponse;->getJSONObject()Lorg/json/JSONObject;

    move-result-object v12

    .line 198
    .local v12, "jsonRes":Lorg/json/JSONObject;
    ...
    const-string v14, "is_app_indexing_enabled"

    .line 200
    invoke-virtual {v12, v14, v7}, Lorg/json/JSONObject;->optBoolean(Ljava/lang/String;Z)Z
    ...
    .line 204
    invoke-static {v3}, Lcom/facebook/appevents/codeless/CodelessManager;->access$202(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/facebook/appevents/codeless/ViewIndexer;->schedule()V
    ...
    invoke-static {v3}, Lcom/facebook/appevents/codeless/CodelessManager;->access$402(Ljava/lang/Boolean;)Ljava/lang/Boolean;
    :try_end_1
    ...
    .end local v9    # "extInfoArray":Lorg/json/JSONArray;
    .end local v10    # "extInfo":Ljava/lang/String;
    .end local v11    # "res":Lcom/facebook/GraphResponse;
    .end local v12    # "jsonRes":Lorg/json/JSONObject;
    :catchall_0
    move-exception v0
