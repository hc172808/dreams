...
.method public run()V
    ...
    .line 154
    .local v1, "this":Lcom/facebook/UserSettingsManager$1;
    :try_start_0
    ...
    .line 160
    .local v4, "advertiser_id":Ljava/lang/String;
    ...
    .line 166
    .end local v1    # "this":Lcom/facebook/UserSettingsManager$1;
    :cond_1
    if-eqz v4, :cond_2
    ...
    .line 168
    .local v7, "codelessSettingsParams":Landroid/os/Bundle;
    ...
    invoke-static {v9, v8, v9}, Lcom/facebook/GraphRequest;->newGraphPathRequest(Lcom/facebook/AccessToken;Ljava/lang/String;Lcom/facebook/GraphRequest$Callback;)Lcom/facebook/GraphRequest;

    move-result-object v8

    .line 175
    .local v8, "codelessRequest":Lcom/facebook/GraphRequest;
    const/4 v9, 0x1

    invoke-virtual {v8, v9}, Lcom/facebook/GraphRequest;->setSkipClientToken(Z)V

    .line 176
    invoke-virtual {v8, v7}, Lcom/facebook/GraphRequest;->setParameters(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v9}, Lcom/facebook/GraphResponse;->getJSONObject()Lorg/json/JSONObject;
    ...
    iput-object v0, v10, Lcom/facebook/UserSettingsManager$UserSetting;->value:Ljava/lang/Boolean;
    ...
    iget-wide v10, v1, Lcom/facebook/UserSettingsManager$1;->val$currTime:J

    iput-wide v10, v0, Lcom/facebook/UserSettingsManager$UserSetting;->lastTS:J
    ...
    .end local v4    # "advertiser_id":Ljava/lang/String;
    .end local v5    # "context":Landroid/content/Context;
    .end local v6    # "identifiers":Lcom/facebook/internal/AttributionIdentifiers;
    .end local v7    # "codelessSettingsParams":Landroid/os/Bundle;
    .end local v8    # "codelessRequest":Lcom/facebook/GraphRequest;
