...
.method public getInstallReferrer()Lcom/android/installreferrer/api/ReferrerDetails;
    ...
    invoke-direct {v1, v2}, Lcom/android/installreferrer/api/ReferrerDetails;-><init>(Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    .line 188
    .local v1, "referrerDetails":Lcom/android/installreferrer/api/ReferrerDetails;
    return-object v1

    .line 189
    .end local v1    # "referrerDetails":Lcom/android/installreferrer/api/ReferrerDetails;
    :catch_0
    move-exception v1
    ...
    invoke-static {v2, v3}, Lcom/android/installreferrer/commons/InstallReferrerCommons;->logWarn(Ljava/lang/String;Ljava/lang/String;)V

    .line 191
    const/4 v2, 0x0

    iput v2, p0, Lcom/android/installreferrer/api/InstallReferrerClientImpl;->mClientState:I
...
.method public startConnection(Lcom/android/installreferrer/api/InstallReferrerStateListener;)V
    ...
    .line 134
    .local v5, "explicitServiceIntent":Landroid/content/Intent;
    ...
    .line 135
    invoke-virtual {v6, v5, v10, v4}, Landroid/content/Context;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z

    move-result v6

    .line 137
    .local v6, "connectionResult":Z
    if-eqz v6, :cond_3

    .line 139
    const-string v1, "Service was bonded successfully."

    invoke-static {v2, v1}, Lcom/android/installreferrer/commons/InstallReferrerCommons;->logVerbose(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 144
    :cond_3
    const-string v10, "Connection to service is blocked."

    invoke-static {v2, v10}, Lcom/android/installreferrer/commons/InstallReferrerCommons;->logWarn(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 151
    .end local v5    # "explicitServiceIntent":Landroid/content/Intent;
    .end local v6    # "connectionResult":Z
    :cond_4
    const-string v4, "Play Store missing or incompatible. Version 8.3.73 or later required."

    invoke-static {v2, v4}, Lcom/android/installreferrer/commons/InstallReferrerCommons;->logWarn(Ljava/lang/String;Ljava/lang/String;)V
