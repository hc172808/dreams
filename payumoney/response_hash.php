...
$query   = $conn->query("select payu_salt from tbl_app_configuration where id=1"); 
...
$salt=$result['payu_salt']; //Please change the value with the live salt for production environment
