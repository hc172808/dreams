<?php
        ...
        private function get_terms_condition() {
            ...
            private function get_coin_types() {
                $this->functions->getCoinTypes();
            }

            private function get_coin_balance() {
                $this->functions->getCoinBalance();
            }

            private function get_coin_transactions() {
