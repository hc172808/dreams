...
$query   = $conn->query("select privacy_policy from tbl_configuration where id=1"); 
...
if(isset($_POST['btnUpdate']))
{
	$txtDesc= mysqli_real_escape_string($conn,$_POST['txtDesc']);
  	...
  	$sql = "UPDATE tbl_configuration set privacy_policy='$txtDesc', modify_by=$userId where id=1";
												...
												<div class="card-body">
													...
													<div class="col-lg-12">
														<div class="form-group">
															<textarea name="txtDesc" class="form-control" required><?php echo $result['privacy_policy']; ?></textarea>
															<script>
