...
$columns = array(
    ...
    // array( 'db' => '`m`.`play_time`',  'dt' => 5, 'field' => 'play_time' ),
    array(
        'db'        => '`m`.`play_time`',
        'dt'        => 5,
        'field' => 'play_time',
        'formatter' => function( $d, $row ) {
            return date( 'jS M y, H:i:s', $d);
        }
    ),
...
$extraWhere = "`m`.`status` = 2 and (`p`.`parti1_status` is NOT NULL or `p`.`parti2_status` is NOT NULL)";
