...
$columns = array(
 ...
 //    ),
	...
	array( 'db' => '`t`.`reg_name`',     'dt' => 8, 'field' => 'reg_name'),
	array( 'db' => '`t`.`reg_number`',     'dt' => 9, 'field' => 'reg_number'),
...
$extraWhere = "`t`.`type` = 0 and `t`.`reg_number` is NOT NULL and `t`.`reg_name` is NOT NULL";
// $groupBy = "`u`.`office`";
