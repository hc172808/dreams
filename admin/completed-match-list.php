...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Completed Match List | <?php echo $appDetRes['app_name']; ?></title>
						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Completed Match List</h5>
									<!--end::Page Title-->
								</div>
								<!--end::Info-->
								<!--begin::Toolbar-->
								...
								<!-- <div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<a href="pending-result-match" class="btn btn-danger">Pending Result Match</a>
											<a href="announced-result-match" class="btn btn-primary">Announced Result Match</a>
										</div>
									</div>
								</div> -->
								<div class="row">
					...
					<script type="text/javascript">
				    	$(document).ready(function() {
						    $('#example').DataTable( {
						        "processing": true,
						        "serverSide": true,
						        "ajax": "data-processing/getCmpltMatch.php?mtstatus=3",
						        "columnDefs": [{"render": function ( data, type, full, meta ) {
					                 ...
					                 }, "data": null, "targets": [4]},{"render": function ( data, type, full, meta ) {
					                     var result_status = full[7];
					                     if(result_status==='0'){
					                     	return '<span>Pending</span>';
					                     }
					                     else
					                     {
					                     	return '<span>Announced</span>';
					                     }
					                 }, "data": null, "targets": [7]}],
						    } );
						} );
